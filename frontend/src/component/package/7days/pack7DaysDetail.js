	...
	render() {
                ...
                <div className='overlay'>
                  <h2>{packages[0].day_meal[4].meal_2.menu_name}</h2>
					...
					<div className='col-sm card-package'>
						...
						<div className='row'>
							<div className='col card-pack-img hovereffect'>
								<img className='card-img img-responsive' src={"\\" + packages[0].day_meal[5].meal_1.img_url} />
                <div className='overlay'>
                  <h2>{packages[0].day_meal[5].meal_1.menu_name}</h2>
                </div>
							</div>
							<div className='col card-pack-img hovereffect'>
								<img className='card-img img-responsive' src={"\\" + packages[0].day_meal[5].meal_2.img_url} />
                <div className='overlay'>
        ...
        <div className='row'>
				...
				<div className='col-sm card-last-package '>
					...
					<div className='row'>
						<div className='col card-pack-img hovereffect'>
							<img className='card-img img-responsive' src={"\\" + packages[0].day_meal[6].meal_1.img_url} />
							<div className='overlay'>
								<h2>{packages[0].day_meal[6].meal_1.menu_name}</h2>
							</div>
						</div>
						<div className='col card-pack-img hovereffect'>
							<img className='card-img img-responsive' src={"\\" + packages[0].day_meal[6].meal_2.img_url} />
							<div className='overlay'>
