    ...
    this.setState(
      {
        ...
        sum_price: Math.round(
          (this.state.day1_detail[0].price +
            ...
            this.state.day4_detail[0].price +
            this.state.day4_detail[1].price +
            this.state.day5_detail[0].price +
            this.state.day5_detail[1].price +
            this.state.day6_detail[0].price +
            this.state.day6_detail[1].price +
            this.state.day7_detail[0].price +
            this.state.day7_detail[1].price) *
            0.95
        )
      },
      () => {
            ...
            this.state.isLoaded && (
              <React.Fragment>
                ...
                <div>
                  ...
                  <button
                    className="btn btn-shownutrition"
                    onClick={() => this.send7DaysPackage("addcart")}
                  >
                    ADD TO CART
                  </button>
                  {/* </a> */}
