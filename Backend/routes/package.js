...
router.get('/user/all', passport.authenticate('jwt', {
    session: false
}), packageControl.getAllUserPackage);
...
router.post('/add', passport.authenticate('jwt', {
    session: false
}), packageControl.addPackage);
//add package to cart anonymous
router.post('/addcart', passport.authenticate('jwt', {
    session: false
}), packageControl.addCart);
//delete package system
router.delete('/del/:id', passport.authenticate('jwt', {
    session: false
}), packageControl.delPackage);
